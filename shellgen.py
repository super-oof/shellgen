...
def produce_output(ip_address,port):
    global php_text
    php_text = php_text.replace("{{ip_address}}",ip_address)
    php_text = php_text.replace("{{port}}",port)
...
def main():
    ...
    if validate_args(args):
        produce_output(args.ip_address,args.port)
